<template>
    <div>
        ...
        <q-table :filter="filter" separator="horizontal" flat bordered :columns="columns" :data="getExpenses">
...
export default {
    ...
    methods: {
        handleFromDate: function(value){
            this.$store.commit('expenses/setFromDate', value)
        },
        handleToDate: function(value){
            this.$store.commit('expenses/setToDate', value)
        },
    ...
    computed: {
        ...mapGetters({
            ...
            getDateFilterDisplay: 'expenses/getDateFilterDisplay',
            getFromDate: 'expenses/getFromDate',
            getToDate: 'expenses/getToDate'
        }),
        columns: function(){
            return this.$store.state.expenses.columns
        }
    }
}
</script>